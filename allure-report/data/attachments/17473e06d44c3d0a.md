...
- Name: ui\accountCreation.spec.ts >> TS-01 Successful Account Creation
- Location: tests\ui\accountCreation.spec.ts:5:5
...
```ts
  ...
  21 |     }
  22 | 
  23 |     async createAccount() {
> 24 |         await this.openNewAccountLink.click();
     |                                       ^ Error: locator.click: Test timeout of 30000ms exceeded.
  25 |         await this.accountType.selectOption(data.accountType);
